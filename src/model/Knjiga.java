...
public class Knjiga {
    ...
    private Autor autor;
    private String ISBN; //identifikacioni broj knjige
    //NAPOMENA: jmbg i te identifikac. brojeve uvek kao String
    private int godinaIzdanja;
    private Zanr zanr;
    
    //konstruktori: prvo napravi jedan prazan pa onda onaj sto prima se parametre
